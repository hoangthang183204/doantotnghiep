...
<aside class="sidebar" id="sidebar">
    <div class="flex flex-col h-full">
        ...
        <div class="flex items-center justify-between px-4 py-4 border-b border-gray-200 dark:border-gray-700">
            ...
            <button id="toggleSidebarBtn" class="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 toggle-btn">
        ...
        <nav class="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
            ...
            <!-- Nhân sự -->
            <div class="pt-4">
                <p class="px-3 text-xs font-semibold text-gray-400 uppercase tracking-wider">Nhân sự</p>
            ...
            <!-- Chấm công -->
            <div class="pt-4">
                <p class="px-3 text-xs font-semibold text-gray-400 uppercase tracking-wider">Chấm công</p>
                ...
                <button onclick="toggleSubmenu('attendanceSubMenu')" 
                    ...
                    <i class="fas fa-chevron-down ml-auto text-xs arrow-icon transition-transform duration-200 {{ request()->routeIs('employee.cham-cong*') ? 'rotate-180' : '' }}"></i>
                </button>
                <div id="attendanceSubMenu" class="submenu space-y-1 pl-8 {{ request()->routeIs('employee.cham-cong*') ? '' : 'hidden' }}">
                    ...
                    <a href="#" class="flex items-center px-3 py-2 rounded-lg text-sm transition-colors duration-200 text-gray-600 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700">
            ...
            <!-- Lương -->
            <div class="pt-4">
                <p class="px-3 text-xs font-semibold text-gray-400 uppercase tracking-wider">Lương</p>
                <a href="#" class="menu-toggle flex items-center px-3 py-2.5 rounded-lg text-sm font-medium transition-colors duration-200 text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700">
            ...
            <!-- Nghỉ phép -->
            <div class="pt-4">
                <p class="px-3 text-xs font-semibold text-gray-400 uppercase tracking-wider">Nghỉ phép</p>
                ...
                <button onclick="toggleSubmenu('leaveSubMenu')" 
                    ...
                    <i class="fas fa-chevron-down ml-auto text-xs arrow-icon transition-transform duration-200 {{ request()->routeIs('employee.don-nghi*') ? 'rotate-180' : '' }}"></i>
                </button>
                <div id="leaveSubMenu" class="submenu space-y-1 pl-8 {{ request()->routeIs('employee.don-nghi*') ? '' : 'hidden' }}">
