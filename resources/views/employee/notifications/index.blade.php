{{-- resources/views/employee/notifications/index.blade.php --}}
...
<div class="container mx-auto px-4 py-6">
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
        <div class="p-4 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center">
            <h2 class="text-lg font-semibold text-gray-900 dark:text-white">Thông báo</h2>
            <div class="flex space-x-2">
                @if($notifications->whereNull('read_at')->count() > 0)
                    <a href="{{ route('employee.notifications.mark-all-read') }}" 
                        ...
                        <div class="ml-3 flex-1">
                            ...
                            <div class="mt-2 flex space-x-2">
                                ...
                                @if(!$notification->read_at)
                                    <a href="{{ route('employee.notifications.mark-read', $notification->id) }}" 
