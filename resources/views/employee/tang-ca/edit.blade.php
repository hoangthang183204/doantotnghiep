            ...
            <form action="{{ route('employee.tang-ca.update', $tangCa->id) }}" method="POST">
                ...
                <div class="p-6 space-y-4">
                    ...
                    <div>
                        ...
                        <input type="date" name="ngay_tang_ca"
                            value="{{ old('ngay_tang_ca', $tangCa->ngay_tang_ca->format('Y-m-d')) }}"
                    ...
                    <div>
                        ...
                        <select name="loai_tang_ca"
                            ...
                            required>
                            <option value="ngay_thuong"
                                {{ old('loai_tang_ca', $tangCa->loai_tang_ca) == 'ngay_thuong' ? 'selected' : '' }}>Ngày thường (150%)</option>
                            <option value="ngay_nghi"
                                {{ old('loai_tang_ca', $tangCa->loai_tang_ca) == 'ngay_nghi' ? 'selected' : '' }}>Ngày nghỉ (200%)</option>
                        </select>
                        @error('loai_tang_ca')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div
                        ...
                        <p class="text-sm text-yellow-700 dark:text-yellow-400">
                            ...
                            Đơn đang ở trạng thái: <strong>Chờ duyệt</strong>. Sau khi chỉnh sửa, đơn sẽ được gửi lại để
                            duyệt.
                        </p>
                    </div>
