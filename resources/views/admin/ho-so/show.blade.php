                ...
                <div class="w-1/4 flex flex-col items-center">
                    ...
                    @if ($hoSo->anh_dai_dien)
                        <img src="{{ asset('storage/' . $hoSo->anh_dai_dien) }}" alt="Ảnh đại diện"
                            class="w-40 h-40 rounded-full object-cover shadow border-4 border-white">
                    @else
                        <div
                            class="w-40 h-40 rounded-full bg-gray-200 flex items-center justify-center text-gray-600 text-6xl shadow">
                            👤
                        </div>
                    @endif
