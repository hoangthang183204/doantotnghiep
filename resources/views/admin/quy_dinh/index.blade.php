...
<style>
    ...
    .text-primary { color: #3b59d6; }
    .text-success { color: #22c55e; }
    .text-warning { color: #f59e0b; }
    .text-info { color: #14b8a6; }
    ...
    .banner-quy-dinh h4 { margin: 0 0 4px 0; font-size: 20px; }
    
    .card-custom {
        background: #fff; border-radius: 12px; overflow: hidden;
        box-shadow: 0 2px 10px rgba(15, 23, 42, 0.05); border: 1px solid #f1f5f9;
    }
    .stat-card {
    ...
    .stat-card h5 { margin: 0; font-size: 18px; }
    .stat-icon { font-size: 28px; margin-bottom: 12px; }

    .card-header-custom { padding: 16px 20px; font-weight: 600; border-bottom: 1px solid #f1f5f9; background: #fff; }
    ...
    .accordion-button {
        ...
        font-weight: 500; cursor: pointer; display: flex; align-items: center; color: #334155;
        font-size: 15px; transition: background-color 0.2s, color 0.2s;
    }
    .accordion-button.active { color: #3b59d6; background-color: #f8fafc; }
    
    /* MŨI TÊN (MỚI THÊM) */
    .toggle-icon {
        margin-left: auto; /* Đẩy icon sang kịch mép phải */
        transition: transform 0.3s ease; /* Hiệu ứng xoay mượt */
        color: #94a3b8;
        font-size: 14px;
    }
    .accordion-button.active .toggle-icon {
        transform: rotate(180deg); /* Xoay ngược lên khi đang mở */
        color: #3b59d6; /* Đổi màu xanh cho tone-sur-tone */
    }

    .accordion-collapse { display: none; padding: 0 20px 16px 20px; }
    .accordion-collapse.show { display: block; }
    .stt-circle {
        display: inline-flex; align-items: center; justify-content: center;
        width: 28px; height: 28px; border-radius: 50%; color: white; font-size: 12px;
    ...
    .hr-btn {
        ...
        text-decoration: none; transition: 0.2s; border: 1px solid transparent; background: transparent;
    }
    .hr-btn-light { border-color: rgba(255,255,255,0.5); color: white; }
    .hr-btn-light:hover { background: white; color: #253fa8; }
    .hr-btn-primary { border-color: #3b59d6; color: #3b59d6; width: 100%; margin-bottom: 12px; }
    .hr-btn-primary:hover { background: #3b59d6; color: white; }
    .hr-btn-success { border-color: #22c55e; color: #22c55e; width: 100%; margin-bottom: 12px; }
    .hr-btn-success:hover { background: #22c55e; color: white; }
    .hr-btn-secondary { border-color: #64748b; color: #64748b; width: 100%; }
    .hr-btn-secondary:hover { background: #64748b; color: white; }
    ...
    .hr-modal-content {
        ...
        box-shadow: 0 10px 25px rgba(0,0,0,0.1); animation: modalFadeIn 0.3s ease;
    }
    @keyframes modalFadeIn { from { opacity: 0; transform: translateY(-20px); } to { opacity: 1; transform: translateY(0); } }
    .hr-modal-header { padding: 16px 20px; border-bottom: 1px solid #f1f5f9; }
    .hr-modal-header h5 { margin: 0; font-size: 18px; }
    .hr-close-btn { background: none; border: none; font-size: 24px; cursor: pointer; color: #64748b; line-height: 1; }
...
<div class="hr-wrapper">
    ...
    <div class="hr-stats-row">
        <div class="stat-card">
            ...
            <h5 class="text-primary fw-bold">08:30 - 17:30</h5>
        </div>
        <div class="stat-card">
            ...
            <div class="card-custom" id="export-pdf-content">
                ...
                <div>
                    <div class="accordion-item">
                        <button class="accordion-button active" type="button" onclick="toggleQuyDinh('collapseOne', this)">
                        ...
                        <div id="collapseOne" class="accordion-collapse show">
                            ...
                            <div class="ms-3 mb-3 text-muted small">Đi muộn quá 15 phút hoặc về sớm trước 15 phút sẽ cần gửi lý do và chờ cấp trên duyệt mới được tính công.</div>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseTwo" class="accordion-collapse">
                            ...
                            <ul class="list-unstyled ms-3 mb-3 text-muted small">
                                ...
                                <li class="mb-1"><i class="fas fa-check text-success me-2"></i> Ca tăng ca được công nhận khi <b>làm đủ/hơn giờ đăng ký</b>.</li>
                                <li><i class="fas fa-times text-danger me-2"></i> Nếu làm <b>ít hơn số giờ đăng ký</b> &rarr; chờ duyệt lại.</li>
                            </ul>
        ...
        <div class="hr-right-col">
            <div class="card-custom sidebar-card border-teal mb-4">
                ...
                <div class="card-body-custom">
                    <div class="d-flex align-items-center mb-4">
                        <img src="{{ asset('images/avatar-default.png') }}" alt="HR" width="48" height="48" style="border-radius: 50%; object-fit: cover; background: #eee; margin-right: 12px;">
                        <div>
            ...
            <div class="card-custom sidebar-card border-green">
                ...
                <div class="card-body-custom text-center">
                    ...
                    <a href="mailto:ke.toan@hrflow.com?subject=Hỏi đáp về Quy định công ty" class="hr-btn hr-btn-success">
    ...
    <div class="hr-modal-content">
        ...
        <div class="card-body-custom">
            <div class="hr-timeline-item">
                ...
                <div class="text-dark small">- Cập nhật số lượng nhân viên.<br>- Bổ sung quy định giờ làm việc Thứ 7.</div>
            </div>
            <div class="hr-timeline-item">
...
<script>
    ...
    function openModal() { document.getElementById('modalLichSu').classList.add('show'); }
    function closeModal() { document.getElementById('modalLichSu').classList.remove('show'); }
