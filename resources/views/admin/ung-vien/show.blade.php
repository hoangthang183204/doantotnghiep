...
<div class="p-6 max-w-4xl mx-auto space-y-6">
        ...
        <div class="p-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        <label class="text-sm text-gray-500 dark:text-gray-400">Kinh nghiệm</label>
                        <p class="font-semibold text-gray-900 dark:text-white">
                            {{ number_format($ungVien->kinh_nghiem ?? 0, 1) }} năm
                        </p>
                    </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm p-6">
        ...
        <div>
            ...
            <p>
                <a href="{{ asset('storage/' . $ungVien->cv_path) }}" 
                   target="_blank" 
                   class="inline-flex items-center gap-2 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-xl text-sm font-medium transition">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 2v4a2 2 0 002 2h4m-6 9l-3 3m0 0l-3-3m3 3V8m-5 10h14"/>
                    </svg>
                    Xem CV
                </a>
            </p>
