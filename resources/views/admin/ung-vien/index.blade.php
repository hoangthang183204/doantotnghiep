...
<div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            ...
            <table class="w-full table-auto">
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                    ...
                    <tr class="hover:bg-blue-50/40 dark:hover:bg-gray-700/40 transition">
                        ...
                        <td class="px-5 py-4">
                            <span class="px-3 py-1 rounded-lg bg-gray-100 dark:bg-gray-700 text-xs font-semibold font-semibold text-gray-900 dark:text-white">
                                {{ $item->ma_ho_so }}
                            </span>
                        </td>
                        ...
                        <td class="px-5 py-4 font-semibold text-gray-900 dark:text-white">{{ $item->so_dien_thoai }}</td>
                        ...
                        <td class="px-5 py-4 font-semibold text-gray-900 dark:text-white">
                            {{ $item->tinTuyenDung?->chucVu?->ten_chuc_vu }}
                        </td>
   ...
   class="px-3 py-1 rounded-lg bg-blue-50 text-blue-600 text-xs">
    ...
    <a href="{{ route('admin.ung_vien.edit', $item->id) }}"
       class="px-3 py-1 rounded-lg bg-amber-50 text-amber-600 text-xs">
        Sửa
    </a>
