...
<div class="space-y-6">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('admin.hop-dong.index') }}" class="px-4 py-2 bg-gray-500 hover:bg-gray-600 text-white rounded-lg transition">
                ← Quay lại
            </a>
        </div>
    </div>
            ...
            <div class="p-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="nguoi_dung_id" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500" required>
                            <option value="">-- Chọn nhân viên --</option>
                            @foreach($nhanViens as $nv)
                                <option value="{{ $nv->id }}" {{ old('nguoi_dung_id') == $nv->id ? 'selected' : '' }}>
                                    {{ optional($nv->hoSo)->ho ?? '' }} {{ optional($nv->hoSo)->ten ?? '' }} ({{ optional($nv->hoSo)->ma_nhan_vien ?? 'N/A' }})
                                </option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div>
                        ...
                        <select name="chuc_vu_id" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500" required>
                    ...
                    <div>
                        ...
                        <input type="text" name="so_hop_dong" value="{{ old('so_hop_dong', $soHopDongTuDong ?? '') }}" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500" required>
                    </div>
                    ...
                    <div>
                        ...
                        <select name="loai_hop_dong" id="loai_hop_dong" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500" required>
                    ...
                    <div>
                        ...
                        <input type="date" name="ngay_bat_dau" value="{{ old('ngay_bat_dau') }}" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500" required>
                    </div>

                    {{-- Ngày kết thúc --}}
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                            Ngày kết thúc <span class="text-red-500" id="ngay_ket_thuc_required" style="display: none;">*</span>
                        </label>
                        <input type="date" name="ngay_ket_thuc" id="ngay_ket_thuc" value="{{ old('ngay_ket_thuc') }}" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500">
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="dia_diem_lam_viec" value="{{ old('dia_diem_lam_viec') }}" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500" required>
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="dieu_khoan" rows="5" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500" required>{{ old('dieu_khoan') }}</textarea>
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="file" name="file_hop_dong[]" multiple class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500" accept=".pdf,.doc,.docx" required>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="ghi_chu" rows="3" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500">{{ old('ghi_chu') }}</textarea>
                    </div>
                ...
                <div class="flex justify-end gap-3 mt-6 pt-4 border-t border-gray-200 dark:border-gray-700">
                    <a href="{{ route('admin.hop-dong.index') }}" class="px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition">
                        Hủy
                    </a>
