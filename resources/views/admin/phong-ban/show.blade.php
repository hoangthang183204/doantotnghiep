...
@section('content')
    <div class="space-y-6">
        ...
        {{-- SUCCESS --}}
        @if (session('success'))
            <div class="p-4 rounded-lg bg-green-100 text-green-700 dark:bg-green-900 dark:text-green-200">
                {{ session('success') }}
            </div>
        @endif
        ...
        {{-- ERROR --}}
        @if (session('error'))
            <div class="p-4 rounded-lg bg-red-100 text-red-700 dark:bg-red-900 dark:text-red-200">
                {{ session('error') }}
            </div>
        @endif
                ...
                <div class="overflow-x-auto">
                    ...
                    <table class="min-w-full">
                        ...
                        <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tr>
                                <th class="py-4 text-left w-1/3 text-gray-500 dark:text-gray-400">
                                    Mã phòng ban
                                </th>
                            ...
                            <tr>
                                <th class="py-4 text-left text-gray-500 dark:text-gray-400">
                                    Tên phòng ban
                                </th>
                            ...
                            <tr>
                                ...
                                <td class="py-4 text-gray-700 dark:text-gray-200">
                                    @if ($phongBan->truongPhong)
                                        @if ($phongBan->truongPhong->hoSo)
                                            {{ $phongBan->truongPhong->hoSo->ho }} {{ $phongBan->truongPhong->hoSo->ten }}
                                        @else
                                            {{ $phongBan->truongPhong->ten_dang_nhap }}
                                        @endif
                                    @else
