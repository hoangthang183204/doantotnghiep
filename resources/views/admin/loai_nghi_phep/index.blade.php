...
<div class="p-6 max-w-7xl mx-auto space-y-6">
    ...
    @if(session('success'))
        <div class="p-4 mb-4 text-sm text-green-800 rounded-2xl bg-green-50 dark:bg-gray-800 dark:text-green-400 border border-green-100 dark:border-green-900" role="alert">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm p-4">
        <div class="max-w-lg relative">
            ...
            <input type="text" placeholder="Tìm kiếm loại nghỉ phép..."
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm overflow-hidden">
        ...
        <div class="overflow-x-auto">
            <table class="w-full table-auto">
                <thead>
                    <tr class="bg-gradient-to-r from-slate-50 to-gray-50 dark:from-gray-700 dark:to-gray-800 text-gray-500 dark:text-gray-400 border-b border-gray-100 dark:border-gray-700">
                        <th class="px-5 py-4 text-left text-xs font-bold uppercase tracking-wider">Mã</th>
                        <th class="px-5 py-4 text-left text-xs font-bold uppercase tracking-wider">Tên loại nghỉ phép</th>
                ...
                @forelse($dsLoaiNghi as $item)
                    <tr class="hover:bg-blue-50/40 dark:hover:bg-gray-700/40 transition-all duration-200">
                        {{-- Mã --}}
                        <td class="px-5 py-4">
                            <span class="inline-flex items-center px-3 py-1 rounded-lg bg-slate-100 dark:bg-gray-700 text-slate-700 dark:text-gray-300 font-semibold text-xs border border-slate-200 dark:border-gray-600 shadow-sm">
                                {{ $item->ma }}
                            </span>
                        </td>
                        ...
                        <td class="px-5 py-4 text-center">
                            ...
                            @else
                                <span class="inline-flex items-center px-3 py-1 rounded-full bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-400 text-xs font-semibold">
                                    ✕ Không lương
                                </span>
                            @endif
                        </td>
                        ...
                        <td class="px-5 py-4 text-center">
                            @if($item->trang_thai)
                                <span class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-400 text-xs font-medium">
                                    <span class="w-2 h-2 bg-emerald-500 rounded-full"></span>
                                    Hoạt động
                                </span>
                            @else
                                <span class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 text-xs font-medium">
                        ...
                        {{-- Ngày tạo --}}
                        <td class="px-5 py-4 text-center text-sm text-gray-500 dark:text-gray-400 whitespace-nowrap">
