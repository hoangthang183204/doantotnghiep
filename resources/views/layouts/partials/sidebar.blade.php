...
@php
    ...
    $hasAdminPermission = $canViewEmployee || $canViewUser || $canViewDepartment || 
                          $canViewChucVu || $canViewRole || $canViewAttendance || 
                          $canManageOvertime || $canApproveAdjustment || $canViewSalary || 
                          $canViewAllowance || $canViewRecruitment || $canViewCandidate || 
                          $canViewPassed || $canViewContract || $canApproveLeave || 
                          $canViewLeaveType || $canViewRegulation || $canViewTime || 
                          $canManagePermission;
...
<aside id="sidebar" class="sidebar">
    ...
    <nav class="h-full overflow-y-auto px-3 py-4 pb-24">
        <ul class="space-y-1">
            ...
            {{-- 1b. Thống kê cá nhân (Employee) - CHỈ HIỂN THỊ KHI KHÔNG PHẢI SUPER ADMIN --}}
            @if($showEmployeeMenus && $canViewDashboardEmployee)
            <li>
            ...
            <li>
                <details class="menu-details" {{ in_array($currentRoute, ['admin.ho-so.index', 'admin.nguoi-dung.index', 'admin.phong-ban.index', 'admin.chuc-vu.index', 'admin.vai-tro.index']) ? 'open' : '' }}>
                    <summary class="flex items-center w-full px-3 py-2.5 rounded-lg transition-colors cursor-pointer {{ in_array($currentRoute, ['admin.ho-so.index', 'admin.nguoi-dung.index', 'admin.phong-ban.index', 'admin.chuc-vu.index', 'admin.vai-tro.index']) ? 'bg-blue-50 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700' }}">
                        <span class="w-5 h-5 mr-3 flex-shrink-0">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                        ...
                        <svg class="w-4 h-4 transition-transform duration-200 arrow-icon flex-shrink-0 {{ in_array($currentRoute, ['admin.ho-so.index', 'admin.nguoi-dung.index', 'admin.phong-ban.index', 'admin.chuc-vu.index', 'admin.vai-tro.index']) ? 'rotate-180' : '' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <li>
                <details class="menu-details" {{ in_array($currentRoute, ['admin.cham-cong.index', 'admin.tang-ca.index', 'admin.yeu-cau-dieu-chinh-cong.index']) ? 'open' : '' }}>
                    <summary class="flex items-center w-full px-3 py-2.5 rounded-lg transition-colors cursor-pointer {{ in_array($currentRoute, ['admin.cham-cong.index', 'admin.tang-ca.index', 'admin.yeu-cau-dieu-chinh-cong.index']) ? 'bg-blue-50 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700' }}">
                        <span class="w-5 h-5 mr-3 flex-shrink-0">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                        ...
                        <svg class="w-4 h-4 transition-transform duration-200 arrow-icon flex-shrink-0 {{ in_array($currentRoute, ['admin.cham-cong.index', 'admin.tang-ca.index', 'admin.yeu-cau-dieu-chinh-cong.index']) ? 'rotate-180' : '' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                        </svg>
                    </summary>
                    <ul class="pl-10 mt-1 space-y-1">
            ...
            {{-- ========================================================== --}}
            @if($showEmployeeMenus && ($canCheckin || $canCheckout || $canViewAttendanceHistory))
            <li>
            ...
            {{-- ========================================================== --}}
            @if($showEmployeeMenus && ($canCreateOvertime || $canViewOvertime))
            <li>
            ...
            {{-- ========================================================== --}}
            @if($showEmployeeMenus && ($canCreateAdjustment || $canViewAdjustment))
            <li>
            ...
            <li>
                <details class="menu-details" {{ in_array($currentRoute, ['admin.bang-luong.index', 'admin.phu-cap.index']) ? 'open' : '' }}>
                    <summary class="flex items-center w-full px-3 py-2.5 rounded-lg transition-colors cursor-pointer {{ in_array($currentRoute, ['admin.bang-luong.index', 'admin.phu-cap.index']) ? 'bg-blue-50 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700' }}">
                        <span class="w-5 h-5 mr-3 flex-shrink-0">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                        ...
                        <svg class="w-4 h-4 transition-transform duration-200 arrow-icon flex-shrink-0 {{ in_array($currentRoute, ['admin.bang-luong.index', 'admin.phu-cap.index']) ? 'rotate-180' : '' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                        </svg>
                    </summary>
                    <ul class="pl-10 mt-1 space-y-1">
            ...
            {{-- ========================================================== --}}
            @if($showEmployeeMenus && $canViewPayroll)
            <li>
            ...
            <li>
                <details class="menu-details" {{ in_array($currentRoute, ['admin.tin-tuyen-dung.index', 'admin.ung_vien.index', 'admin.trung-tuyen.index']) ? 'open' : '' }}>
                    <summary class="flex items-center w-full px-3 py-2.5 rounded-lg transition-colors cursor-pointer {{ in_array($currentRoute, ['admin.tin-tuyen-dung.index', 'admin.ung_vien.index', 'admin.trung-tuyen.index']) ? 'bg-blue-50 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700' }}">
                        <span class="w-5 h-5 mr-3 flex-shrink-0">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/>
                            </svg>
                        ...
                        <svg class="w-4 h-4 transition-transform duration-200 arrow-icon flex-shrink-0 {{ in_array($currentRoute, ['admin.tin-tuyen-dung.index', 'admin.ung_vien.index', 'admin.trung-tuyen.index']) ? 'rotate-180' : '' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                        </svg>
                    </summary>
                    <ul class="pl-10 mt-1 space-y-1">
            ...
            {{-- ========================================================== --}}
            @if($showEmployeeMenus && $canViewContractPersonal)
            <li>
            ...
            {{-- ========================================================== --}}
            @if($showEmployeeMenus && ($canViewLeaveHistory || $canRequestLeave))
            <li>
            ...
            @if($showEmployeeMenus && $canViewRegulationEmployee)
            <li>
            ...
            <li>
                <details class="menu-details" {{ in_array($currentRoute, ['admin.phan-quyen.index', 'admin.quan-ly-thoi-gian.index']) ? 'open' : '' }}>
                    <summary class="flex items-center w-full px-3 py-2.5 rounded-lg transition-colors cursor-pointer {{ in_array($currentRoute, ['admin.phan-quyen.index', 'admin.quan-ly-thoi-gian.index']) ? 'bg-blue-50 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700' }}">
                        <span class="w-5 h-5 mr-3 flex-shrink-0">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                        ...
                        <svg class="w-4 h-4 transition-transform duration-200 arrow-icon flex-shrink-0 {{ in_array($currentRoute, ['admin.phan-quyen.index', 'admin.quan-ly-thoi-gian.index']) ? 'rotate-180' : '' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                        </svg>
                    </summary>
                    <ul class="pl-10 mt-1 space-y-1">
