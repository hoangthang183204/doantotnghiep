        ...
        [
            ...
            'submenu' => [
                [
                    ...
                    'active' => str_contains($currentRoute, 'nguoi-dung'),
                ],
                [
                    'title' => 'Phòng ban',
                    ...
                    'active' => str_contains($currentRoute, 'phong-ban'),
                ],
                [
                    'title' => 'Chức vụ',
                    ...
                    'active' => str_contains($currentRoute, 'chuc-vu'),
                ],
            ],
        ],
        [
            ...
            'submenu' => [
                [
                    ...
                    'active' => str_contains($currentRoute, 'cham-cong'),
                ],
        ...
        [
            ...
            'submenu' => [
                [
                    ...
                    'active' => str_contains($currentRoute, 'bang-luong'),
                ],
                [
                    'title' => 'Phụ cấp',
                    ...
                    'icon' =>
                        '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>',
                    'active' => str_contains($currentRoute, 'phu-cap'),
                ],
            ],
        ],
        [
            ...
            'submenu' => [
                [
                    ...
                    'route' => 'admin.tin-tuyen-dung.index',
                    'icon' =>
                        '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z"/>',
                    'active' => str_contains($currentRoute, 'tin-tuyen-dung'),
                ],
                [
                    'title' => 'Ứng viên',
                    'route' => 'admin.ung-vien.index',
                    'icon' =>
                        '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/>',
                    'active' => str_contains($currentRoute, 'ung-vien'),
                ],
            ],
        ],
    ];
...
<aside class="sidebar">
    <div class="flex items-center justify-between px-4 py-4 border-b dark:border-gray-700">
        <a href="{{ route('admin.dashboard') }}" class="flex items-center space-x-2">
            ...
            <span class="text-xl font-bold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">HR
                Flow</span>
        </a>
