            ...
            <table class="w-full text-sm">
                <thead>
                    <tr class="bg-gray-50 dark:bg-gray-700/50">
                        ...
                        <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase">Giờ</th>
                        ...
                        <td class="px-4 py-3">
                            <div class="flex items-center gap-2">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-400">{{ $item->nguoi_dung->hoSo->ma_nhan_vien ?? 'N/A' }}</p>
                                </div>
                            </div>
                        </td>
                        <td class="px-4 py-3">{{ \Carbon\Carbon::parse($item->ngay_tang_ca)->format('d/m/Y') }}</td>
