                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                    @foreach ($thongKeLoaiNghi as $item)
                        <div class="bg-gray-50 dark:bg-gray-700/30 rounded-lg p-4 text-center">
                            <p class="text-sm text-gray-500 dark:text-gray-400">{{ $item->loaiNghiPhep->ten ?? 'Khác' }}
                            </p>
                    ...
                    <tbody class="divide-y divide-gray-100 dark:divide-gray-700/50">
                        @forelse($donNghis as $don)
                            <tr class="hover:bg-gray-50/50 dark:hover:bg-gray-700/30 transition-colors">
                                <td class="px-4 py-3 font-medium text-gray-900 dark:text-white">{{ $don->ma_don_nghi }}
                                </td>
                                <td class="px-4 py-3">
