...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('luong_nhan_vien', function (Blueprint $table) {
            ...
            $table->decimal('tong_phu_cap', 15, 2)->default(0);
            $table->decimal('tong_khau_tru', 15, 2)->default(0);
            $table->decimal('tong_luong', 15, 2)->default(0);
            $table->decimal('luong_thuc_nhan', 15, 2)->default(0);
            $table->decimal('so_ngay_cong', 5, 2)->default(0);
            $table->decimal('gio_tang_ca', 5, 2)->default(0);
            $table->decimal('cong_tang_ca', 5, 2)->default(0);
            ...
            $table->decimal('thue_thu_nhap_ca_nhan', 15, 2)->default(0);
